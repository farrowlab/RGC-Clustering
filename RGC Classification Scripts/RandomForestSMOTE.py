...
import pickle
f = open ('/media/areca_raid/Classification Scripts/Data/traindata.txt','r').readlines()
...
f2 = open('/media/areca_raid/Classification Scripts/Data/testdata.txt','r').readlines()
N = len(f2) 
l = [];
for i in range(0,N):
	w = f2[i].split(',')
...
joblib.dump(model, '/media/areca_raid/Classification Scripts/Model/RandomForrestTrainModel.pkl')

tfile = open('/media/areca_raid/Classification Scripts/Labels/classesLABEL2.txt','w')
pfile = open('/media/areca_raid/Classification Scripts/Labels/classesPROB2.txt','w')
for item in classes:
	for stuff in item:	
		tfile.write("%s\n" % str(stuff)) 
#	tfile.write("\n")
