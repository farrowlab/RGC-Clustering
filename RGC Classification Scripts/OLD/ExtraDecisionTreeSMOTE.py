...
joblib.dump(model, '/media/areca_raid/Classification Scripts/Model/ExtraTreesTrainModel.pkl')

tfile = open('/media/areca_raid/Classification Scripts/Labels/classesLABEL.txt','w')
pfile = open('/media/areca_raid/Classification Scripts/Labels/classesPROB.txt','w')
for item in classes:
	for stuff in item:	
		tfile.write("%s\n" % str(stuff)) 
#	tfile.write("\n")
